// ═══════════════════════════════════════════════════════════════════════════════
// NBA BRAIN PRO v10.2 ETERNUM - RESILIENTE
...
class TriadCognitive {
  ...
  async proposerThink(game, agent) {
    ...
    let prediction;
    try {
      prediction = agent.state.brain.predict(tf.tensor2d([features]));
    } catch (err) {
...
${CONFIG.MOCK_MODE ? '⚠️ MODO MOCK (dados temporários)' : '✅ MODO PRODUÇÃO'}
